...
export const KPI: Record<string, KpiSet> = {
  ...
  DE: { pipeline: 47.1, revenue: 52.6, coverage: 64, reuse: 68, signals: 118, conv: 11, outreach: 41, meetings: 18, oppsCreated: 18, stageConv: 36, pTarget: 60, rTarget: 70, cTarget: 70, clients: 210, targetAccounts: 64, activeAccounts: 41, campaigns: 5, partners: 9, assets: 62, agents: 9, qualifiedLeads: 11, tBookings: 70, tPipeline: 60, tCoverage: 70 },
  UK: { pipeline: 33.7, revenue: 38.2, coverage: 53, reuse: 64, signals: 87, conv: 8, outreach: 29, meetings: 14, oppsCreated: 14, stageConv: 34, pTarget: 45, rTarget: 55, cTarget: 65, clients: 180, targetAccounts: 55, activeAccounts: 29, campaigns: 4, partners: 8, assets: 48, agents: 9, qualifiedLeads: 8, tBookings: 55, tPipeline: 45, tCoverage: 65 },
  NO: { pipeline: 47.0, revenue: 54.6, coverage: 49, reuse: 57, signals: 162, conv: 15, outreach: 40, meetings: 24, oppsCreated: 18, stageConv: 32, pTarget: 65, rTarget: 72, cTarget: 60, clients: 285, targetAccounts: 100, activeAccounts: 50, campaigns: 9, partners: 19, assets: 108, agents: 9, qualifiedLeads: 15, tBookings: 72, tPipeline: 65, tCoverage: 60 },
};

export const KPI_COUNTRY: Record<string, KpiSet> = {
  Sweden: { pipeline: 16.2, revenue: 19.4, coverage: 53, reuse: 60, signals: 51, conv: 5, outreach: 17, meetings: 8, oppsCreated: 6, stageConv: 31, pTarget: 22, rTarget: 26, cTarget: 62, clients: 95, targetAccounts: 32, activeAccounts: 17, campaigns: 3, partners: 6, assets: 34, agents: 9, qualifiedLeads: 5, tBookings: 26, tPipeline: 22, tCoverage: 62 },
  Finland: { pipeline: 12.8, revenue: 14.1, coverage: 54, reuse: 58, signals: 44, conv: 4, outreach: 14, meetings: 7, oppsCreated: 5, stageConv: 29, pTarget: 17, rTarget: 18, cTarget: 60, clients: 70, targetAccounts: 26, activeAccounts: 14, campaigns: 2, partners: 5, assets: 28, agents: 9, qualifiedLeads: 4, tBookings: 18, tPipeline: 17, tCoverage: 60 },
  Norway: { pipeline: 9.6, revenue: 11.3, coverage: 45, reuse: 55, signals: 36, conv: 3, outreach: 10, meetings: 5, oppsCreated: 4, stageConv: 28, pTarget: 14, rTarget: 15, cTarget: 60, clients: 62, targetAccounts: 22, activeAccounts: 10, campaigns: 2, partners: 4, assets: 24, agents: 9, qualifiedLeads: 3, tBookings: 15, tPipeline: 14, tCoverage: 60 },
  Denmark: { pipeline: 8.4, revenue: 9.8, coverage: 45, reuse: 56, signals: 31, conv: 3, outreach: 9, meetings: 4, oppsCreated: 3, stageConv: 27, pTarget: 12, rTarget: 13, cTarget: 60, clients: 58, targetAccounts: 20, activeAccounts: 9, campaigns: 2, partners: 4, assets: 22, agents: 9, qualifiedLeads: 3, tBookings: 13, tPipeline: 12, tCoverage: 60 },
};
